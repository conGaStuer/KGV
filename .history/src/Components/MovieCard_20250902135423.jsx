          ...
          <div className="list-movie">
            <div className="movie-poster-card">
              ...
              <div className="poster-detail">
                ...
                <p className="detail-origin">{movie.origin}</p>
                <p>
                ...
                <p className="highlight">Thể loại: Hành Động, Hoạt Hình</p>
                <p className="highlight">Đã chiếu: 8/12</p>
                <p>Giới thiệu: Lorem ipsum...</p>
                <p>Thời lượng: 24 phút</p>
                <p>Quốc gia: Nhật Bản</p>
                <p>Networks: Fuji TV, Tokyo MX...</p>
                <p>Sản xuất: Ufotable, Aniplex</p>
                <p>Đạo diễn: Haruo Sotozaki</p>
              </div>
