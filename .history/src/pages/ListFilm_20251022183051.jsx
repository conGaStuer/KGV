  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        let url = "";
        if (keyword) {
          url = `https://phimapi.com/v1/api/tim-kiem?keyword=${keyword}&category=${keyword}&limit=64`;
        } else if (catSlug) {
        ...
        // log fetched items directly to avoid referencing `movies` inside the effect
