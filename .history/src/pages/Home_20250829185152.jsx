...
import FeatureFilm from "./FeatureFilm.jsx";
import CartoonFilm from "./CartoonFilm.jsx";
import TVShow from "./TVShow.jsx";
import ActionFilm from "./ActionFilm.jsx";
import SchoolFilm from "./SchoolFilm.jsx";
import HorrorFilm from "./HorrorFilm.jsx";
import FictionFilm from "./FictionFilm.jsx";
import VoiceOverFilm from "./VoiceOverFilm.jsx";
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="type-list">
        ...
        <div className="type">
          {cate.slice(0, 7).map((cat, index) => {
            ...
            const nextColor = colors[(index + 1) % colors.length]; // Màu tiếp theo cho gradient
            return (
              <div
                key={cat.id}
                className="cate-card"
      ...
      <FeatureFilm featureFilm={featureFilm} />
      <CartoonFilm cartoonFilm={cartoonFilm} />
      <TVShow tvShow={tvShow} />
      <ActionFilm actionFilm={actionFilm} />
      <SchoolFilm schoolFilm={schoolFilm} />
      <HorrorFilm horrorFilm={horrorFilm} />
      <FictionFilm fictionFilm={fictionFilm} />
      <VoiceOverFilm voiceOverFilm={voiceOverFilm} />
      <Footer />
    </>
  );
}
