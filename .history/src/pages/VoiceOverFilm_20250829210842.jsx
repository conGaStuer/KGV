...
export default function VoiceOverFilm({ voiceOverFilm }) {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
  ...
  return (
    <section className="feature-film-container">
      <p>Top 10 phim hoc duong moi nhat 2025</p>
      <div className="feature-film-list">
        <Slider {...settings}>
          {voiceOverFilm.map((film) => (
            <div key={film._id} className="feature-list">
              <div
