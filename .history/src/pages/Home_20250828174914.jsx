    ...
    const fetchData = async () => {
      try {
        ...
        setCountryMovies({
          ...
          trung: trungRes.data.data.items,
          viet_nam: vietRes.data.data.items,
        });
      } catch (error) {
        ...
        <div className="country">
          <div className="country-side">
            ...
            <div className="country-list-film">
              {countryMovies.han_quoc.slice(0, 3).map((m) => (
                <div className="country-film">
                  <div className="film-bg">1</div>
                  <div key={m._id} className="film-info">
                    <h4>{m.name}</h4>
                    <h5>{m.origin_name}</h5>
                  </div>
                </div>
